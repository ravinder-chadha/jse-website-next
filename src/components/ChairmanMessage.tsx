      ...
      <div className="flex justify-center md:flex-row flex-col border-2 border-jse-primary-400 rounded-lg items-center p-2 gap-5">
        <div className="w-full h-full overflow-hidden">
          <Image
            ...
            height={800}
            // className="object-fill object-top border md:h-[300px] md:w-[400px] h-[400px]  rounded-lg"
            className="object-cover object-center border w-[500px] h-[300px]  rounded-lg"
          />
        </div>

        <div className="flex flex-col items-center  md:gap-5 gap-3 md:pr-6 px-3 h-full ">
          <div className="md:mx-32 mx-4 md:my-0 my-5 flex flex-row justify-center w-full">
            <svg
              width="23"
              height="20"
              viewBox="0 0 23 20"
            ...
            <h3 className="font-serif md:text-xl text-lg md:w-3/4 mx-5 w-full md:text-center text-justify py-4">
