            ...
            <div className='lg:w-7/12 xl:w-7/12 flex-none relative'>
              ...
              <div className='relative flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0'>
                <div className='md:w-1/2 md:mt-24 space-y-6'>
                  <ImageCard imglink='/lib/images/BloodCamp1.jpg' mainTitle='Vaccination Camp' imgDesc='Free vaccination for all.'/>
                  <ImageCard imglink='/lib/images/BloodCamp2.jpg' mainTitle='Blood Donation Camp' imgDesc='Donate blood, save a life.'/>
                </div>
                <div className='md:w-1/2 space-y-6'>
                  <ImageCard imglink='/lib/images/Plantation.jpg' mainTitle='Plantation Drive' imgDesc='Planting 1 lakh trees.'/>
                  <ImageCard imglink='/lib/images/Plantation2.jpg' mainTitle='JSE Youth Club' imgDesc='Youth Club for social work.'/>
                </div>
              </div>
            </div>
