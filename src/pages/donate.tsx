    ...
    <MainLayout headerTransition={false}>
      <>
        <div className="space-y-16 container xl:max-w-7xl mx-auto px-4 lg:px-8 my-10 flex flex-col justify-center">
          <HeadingTitle
            title="Donate and support us now"
            subtitle="Your Support Can Make a Difference"
          ...
          <div className="flex flex-col items-center gap-8">
            <HeadingTitle
              title="Donate us"
              subtitle="We encourage you to fill out our form before payment"
              className="mx-auto text-center"
            />
            <div className="flex flex-col items-center justify-center">
              <span className="block  text-xl">
                We need your necessary details regarding the donations you do.
              </span>
              <span className="block text-xl">
                You can also opt to anonymously donate.
              </span>
            </div>
            <button
              type="button"
              className="w-fit bg-jse-primary-500 text-white font-semibold rounded-lg py-2 px-4 hover:bg-jse-primary-400 focus:outline-none focus:ring focus:ring-jse-primary-300 focus:ring-opacity-50 active:bg-jse-primary-400"
